...
<ul class="normal">
    <li>Launch the <a href="https://developer.avalara.com/api-reference/avatax/rest/v2/methods/Batches/">Batch Creation API</a> in REST v2</li>
...
We'll continue by fetching our batch back from the server.  Launch the <a href="https://developer.avalara.com/api-reference/avatax/rest/v2/methods/Batches/">Batch GET API</a> and type in your company ID and the batch ID you got back from your Batch Create API call.  The result you'll get back will either still say <code class="highlight-rouge">"status": "Waiting"</code>, or it will say <code class="highlight-rouge">"Completed"</code> or <code class="highlight-rouge">"Errors"</code>.  If the batch is still <code class="highlight-rouge">"Waiting"</a>, you'll just want to keep checking back periodically to see when it has finished.
